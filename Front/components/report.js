$(document).ready(function () {
  ...
  $("#loadStudentsButton").click(function () {
      var groupId = $("#groupSelect").val();
      if (groupId) {
          $("#groupSelection").hide();
          $("#studentList").show();
          var groupName = $("#groupSelect option:selected").text();
          $("#groupTitle").text("Группа: " + groupName);
          loadStudentsByGroup(groupId);
      } else {
